      ...
      column(width=12,
        ...
        sliderInput(min=2010, max=2014, step=1,
                    animate = animationOptions(interval=1600,
                                               playButton = HTML('<div style=\'margin-top:-25px; text-align: center; margin-left:150px;  font-size:22pt;\'>&ogt;</div>'),
                                               pauseButton = HTML('<div style=\'margin-top:-25px; text-align: center; margin-left:150px; font-size:22pt;\'>&opar; </div>')),
                    value=2010,
